...
void testSpatialGrid() {
  Particle p1 = Particle(1, 1, 1, Vector(0,0,0), Point3D(0,0,0));
  Particle p2 = Particle(1, 1, 1, Vector(0,0,0), Point3D(1,0,0));
  Particle p3 = Particle(1, 1, 1, Vector(0,0,0), Point3D(0,0,1));
  Particle p4 = Particle(1, 1, 1, Vector(0,0,0), Point3D(0,-9, -9));
  Particle p5 = Particle(1, 1, 1, Vector(0,0,0), Point3D(11,11, 11));
